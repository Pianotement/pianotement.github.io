...
self.addEventListener('fetch', (event) => {
  ...
  event.respondWith(
    fetch(event.request, { cache: 'no-store' }) // ignore volontairement la mise en cache de 10 min imposée par GitHub Pages : on veut toujours la vraie dernière version quand il y a du réseau
      .then((reponse) => {
